...
public class MainView {
    ...
    public boolean pedirConfirmacaoAvanco(int proximoAno) {
        return utils.Consola.lerString("Deseja mesmo avançar para o ano letivo " + proximoAno + "? (S/N): ").equalsIgnoreCase("S");
    }

    public boolean pedirConfirmacaoInicioAno(int ano) {
        return utils.Consola.lerString("Deseja mesmo iniciar o ano letivo " + ano + "? (S/N): ").equalsIgnoreCase("S");
    }

    // =========================================================
    // 4. MENSAGENS DA TRANSIÇÃO DE ANO
    // =========================================================

    public void msgTransicaoAnoNaoPermitida() {
        System.out.println(">> Não é possível avançar o ano letivo porque o ano atual ainda não foi iniciado.");
    }

    public void msgTransicaoBloqueada() {
        System.out.println(">> O ano letivo atual ainda não foi iniciado.");
    }
    ...
    // =========================================================
    // 5. FEEDBACK E MENSAGENS DE SISTEMA
    // =========================================================
